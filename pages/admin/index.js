...
const columns = [
  ...
  },
  {
    field: 'lat',
    headerName: 'Latitud',
    // valueFormatter: (data) => `${data.value.lat},${data.value.lng}`,
    width: 200,
  },
  {
    field: 'lng',
...
const Admin = ({ user, alerts }) => {
  return (
    <Layout page="admin" user={user}>
...
export const getServerSideProps = async (ctx) => {
  ...
  await Axios.get(`${process.env.NEXT_APP_BACKEND_URL}/alerts`, {
    headers: {
      Authorization: `Bearer ${access_token}`,
    },
  })
